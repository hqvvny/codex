...
| 2 | MNQ-003 | 1m 200 EMA retest continuation long/short | User thesis | NQ/MNQ proxy via DATA-001/DATA-002 | Session not fixed | Indicator + mechanical retest candidate | 200 EMA may act as dynamic trend boundary; continuation traders may defend retests while countertrend traders get trapped | DATA-001/DATA-002 1m available; exact retest tolerance, stop, target, and session split needed | Likely enough occurrences across 2017-2026, but not proven until retest rules are fixed | Must test >= 1.5R; not yet defined | raw | Define retest tolerance, trend confirmation, entry timing, stop/target, cooldown, and session scope before build/test | [[hypotheses/MNQ-003-200ema-retest-continuation]], [[../reference/first-filter]] |
