...
This catalog is the first wiki file to read at the start of every substantive session. It links to every maintained page so project memory can be loaded quickly and updated deliberately.

- [[SCHEMA]] - rulebook, templates, workflows, and lint checks.
- [[log]] - append-only chronological project log.
- [[hot]] - auto-generated current state and next actions.
- [[lessons]] - cross-cutting synthesis from completed work.
